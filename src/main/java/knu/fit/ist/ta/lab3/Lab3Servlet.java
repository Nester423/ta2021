...
public class Lab3Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Lab3Task lab3t = new Lab3Task();
        
        int[] def_arr = {21, 21, 5, 5, 3, 12, 40, 5, 5};
      
        int k = Integer.parseInt(request.getParameter("k"));   
        int[] arr = lab3t.arrayPopulation(k);
         
      
        String array = lab3t.output(arr);
        int ame = lab3t.amountOfMaxEl(arr);
        
        request.setAttribute("array", array);
        request.setAttribute("ame", ame);
